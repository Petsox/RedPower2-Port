...
public class Matrix3
{
    ...
    public void set(final Matrix3 m) {
        this.xx = m.xx;
        this.xy = m.xy;
        this.xz = m.xz;
        this.yx = m.yx;
    ...
    public static Matrix3 getRotY(final double angle) {
    ...
    public Vector3 getBasisVector(final int n) {
    ...
    public void rotate(final Vector3 v) {
        final double tx = this.xx * v.x + this.yx * v.y + this.zx * v.z;
        final double ty = this.xy * v.x + this.yy * v.y + this.zy * v.z;
        final double tz = this.xz * v.x + this.yz * v.y + this.zz * v.z;
        v.x = tx;
        v.y = ty;
        v.z = tz;
    }

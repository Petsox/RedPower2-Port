...
public class RedPowerMachine implements IGuiHandler
{
    ...
    private static void setupBlocks() {
        ...
        GameRegistry.registerBlock((Block)RedPowerMachine.blockMachine, (Class)ItemExtended.class, "machine");
        ...
        GameRegistry.registerTileEntity((Class)TileWindTurbine.class, "RPWind");
        GameRegistry.registerTileEntity((Class)TilePipe.class, "RPPipe");
        GameRegistry.registerTileEntity((Class)TilePump.class, "RPPump");
        GameRegistry.registerTileEntity((Class)TileTube.class, "RPTube");
        GameRegistry.registerTileEntity((Class)TileRedstoneTube.class, "RPRSTube");
        GameRegistry.registerTileEntity((Class)TileRestrictTube.class, "RPRTube");
        GameRegistry.registerTileEntity((Class)TileMagTube.class, "RPMTube");
        GameRegistry.registerTileEntity((Class)TileAccel.class, "RPAccel");
        GameRegistry.registerTileEntity((Class)TileDeploy.class, "RPDeploy");
        GameRegistry.registerTileEntity((Class)TileBreaker.class, "RPBreaker");
        GameRegistry.registerTileEntity((Class)TileTranspose.class, "RPTranspose");
        GameRegistry.registerTileEntity((Class)TileFilter.class, "RPFilter");
        GameRegistry.registerTileEntity((Class)TileItemDetect.class, "RPItemDet");
        GameRegistry.registerTileEntity((Class)TileSorter.class, "RPSorter");
        GameRegistry.registerTileEntity((Class)TileBatteryBox.class, "RPBatBox");
        GameRegistry.registerTileEntity((Class)TileMotor.class, "RPMotor");
        GameRegistry.registerTileEntity((Class)TileRetriever.class, "RPRetrieve");
        GameRegistry.registerTileEntity((Class)TileRegulator.class, "RPRegulate");
        GameRegistry.registerTileEntity((Class)TileThermopile.class, "RPThermo");
        GameRegistry.registerTileEntity((Class)TileIgniter.class, "RPIgnite");
        GameRegistry.registerTileEntity((Class)TileAssemble.class, "RPAssemble");
        GameRegistry.registerTileEntity((Class)TileEject.class, "RPEject");
        GameRegistry.registerTileEntity((Class)TileRelay.class, "RPRelay");
    ...
    public void registerRenderers() {
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 0, (Function<Block, ? extends RenderCustomBlock>) RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 1, (Function<Block, ? extends RenderCustomBlock>)RenderBreaker::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 2, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 3, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 4, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 5, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 6, (Function<Block, ? extends RenderCustomBlock>)RenderBatteryBox::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 7, (Function<Block, ? extends RenderCustomBlock>)RenderMotor::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 8, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 9, (Function<Block, ? extends RenderCustomBlock>)RenderWindTurbine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 10, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 11, (Function<Block, ? extends RenderCustomBlock>)RenderThermopile::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 12, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 13, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 14, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine, 15, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine2, 0, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachine2, 1, (Function<Block, ? extends RenderCustomBlock>)RenderMachine::new);
        RenderLib.setRenderer((Block)RedPowerBase.blockAppliance, 1, (Function<Block, ? extends RenderCustomBlock>)RenderBlueFurnace::new);
        RenderLib.setRenderer((Block)RedPowerBase.blockAppliance, 2, (Function<Block, ? extends RenderCustomBlock>)RenderBufferChest::new);
        RenderLib.setRenderer((Block)RedPowerBase.blockAppliance, 4, (Function<Block, ? extends RenderCustomBlock>)RenderBlueAlloyFurnace::new);
        RenderLib.setRenderer((Block)RedPowerBase.blockAppliance, 5, (Function<Block, ? extends RenderCustomBlock>)RenderChargingBench::new);
        RenderLib.setHighRenderer((Block)RedPowerBase.blockMicro, 7, (Function<Block, ? extends RenderCustomBlock>)RenderPipe::new);
        RenderLib.setHighRenderer((Block)RedPowerBase.blockMicro, 8, (Function<Block, ? extends RenderCustomBlock>)RenderTube::new);
        RenderLib.setHighRenderer((Block)RedPowerBase.blockMicro, 9, (Function<Block, ? extends RenderCustomBlock>)RenderRedstoneTube::new);
        RenderLib.setHighRenderer((Block)RedPowerBase.blockMicro, 10, (Function<Block, ? extends RenderCustomBlock>)RenderTube::new);
        RenderLib.setHighRenderer((Block)RedPowerBase.blockMicro, 11, (Function<Block, ? extends RenderCustomBlock>)RenderTube::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachinePanel, 0, (Function<Block, ? extends RenderCustomBlock>)RenderSolarPanel::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachinePanel, 1, (Function<Block, ? extends RenderCustomBlock>)RenderPump::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachinePanel, 2, (Function<Block, ? extends RenderCustomBlock>)RenderAccel::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachinePanel, 3, (Function<Block, ? extends RenderCustomBlock>)RenderGrate::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockMachinePanel, 4, (Function<Block, ? extends RenderCustomBlock>)RenderTransformer::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockFrame, 0, (Function<Block, ? extends RenderCustomBlock>)RenderFrame::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockFrame, 1, (Function<Block, ? extends RenderCustomBlock>)RenderFrameMoving::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockFrame, 2, (Function<Block, ? extends RenderCustomBlock>)RenderFrameTube::new);
        RenderLib.setRenderer((Block)RedPowerMachine.blockFrame, 3, (Function<Block, ? extends RenderCustomBlock>)RenderFrameRedstoneTube::new);

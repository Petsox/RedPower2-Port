...
public class RedPowerBase implements IGuiHandler
{
    ...
    public static void initBaseItems() {
        ...
        for (int color = 0; color < 16; ++color) {
            ...
            GameRegistry.addShapelessRecipe(new ItemStack(RedPowerBase.itemLumar, 2, color), Items.redstone, dye, dye, Items.glowstone_dust);
        }
        ...
        RedPowerBase.itemRuby = new ItemStack(RedPowerBase.itemResource, 1, 0);
        RedPowerBase.itemGreenSapphire = new ItemStack(RedPowerBase.itemResource, 1, 1);
        RedPowerBase.itemSapphire = new ItemStack(RedPowerBase.itemResource, 1, 2);
        RedPowerBase.itemIngotSilver = new ItemStack(RedPowerBase.itemResource, 1, 3);
        RedPowerBase.itemIngotTin = new ItemStack(RedPowerBase.itemResource, 1, 4);
        RedPowerBase.itemIngotCopper = new ItemStack(RedPowerBase.itemResource, 1, 5);
        RedPowerBase.itemNikolite = new ItemStack(RedPowerBase.itemResource, 1, 6);
        RedPowerBase.itemIngotTungsten = new ItemStack(RedPowerBase.itemResource, 1, 7);
        RedPowerBase.itemDustTungsten = new ItemStack(RedPowerBase.itemResource, 1, 8);
        RedPowerBase.itemDustSilver = new ItemStack(RedPowerBase.itemResource, 1, 9);
        RedPowerBase.itemIngotRed = new ItemStack(RedPowerBase.itemAlloy, 1, 0);
        RedPowerBase.itemIngotBlue = new ItemStack(RedPowerBase.itemAlloy, 1, 1);
        RedPowerBase.itemIngotBrass = new ItemStack(RedPowerBase.itemAlloy, 1, 2);
        RedPowerBase.itemBouleSilicon = new ItemStack(RedPowerBase.itemAlloy, 1, 3);
        RedPowerBase.itemWaferSilicon = new ItemStack(RedPowerBase.itemAlloy, 1, 4);
        RedPowerBase.itemWaferBlue = new ItemStack(RedPowerBase.itemAlloy, 1, 5);
        RedPowerBase.itemWaferRed = new ItemStack(RedPowerBase.itemAlloy, 1, 6);
        RedPowerBase.itemTinplate = new ItemStack(RedPowerBase.itemAlloy, 1, 7);
        RedPowerBase.itemFineCopper = new ItemStack(RedPowerBase.itemAlloy, 1, 8);
        RedPowerBase.itemFineIron = new ItemStack(RedPowerBase.itemAlloy, 1, 9);
        RedPowerBase.itemCopperCoil = new ItemStack(RedPowerBase.itemAlloy, 1, 10);
        RedPowerBase.itemMotor = new ItemStack(RedPowerBase.itemAlloy, 1, 11);
        RedPowerBase.itemCanvas = new ItemStack(RedPowerBase.itemAlloy, 1, 12);
        ...
        RedPowerBase.itemNuggetIron = new ItemStack(RedPowerBase.itemNugget, 1, 0);
        RedPowerBase.itemNuggetSilver = new ItemStack(RedPowerBase.itemNugget, 1, 1);
        RedPowerBase.itemNuggetTin = new ItemStack(RedPowerBase.itemNugget, 1, 2);
        RedPowerBase.itemNuggetCopper = new ItemStack(RedPowerBase.itemNugget, 1, 3);
        RedPowerBase.itemNuggetTungsten = new ItemStack(RedPowerBase.itemNugget, 1, 4);
        RedPowerBase.itemDrawplateDiamond = new ItemDrawplate();
        ...
        RedPowerBase.itemBag = new ItemBag();
        GameRegistry.addRecipe(new ItemStack(RedPowerBase.itemBag, 1, 0), "CCC", "C C", "CCC", 'C', RedPowerBase.itemCanvas);
        for (int color = 1; color < 16; ++color) {
            GameRegistry.addRecipe(new ItemStack(RedPowerBase.itemBag, 1, color), "CCC", "CDC", "CCC", 'C', RedPowerBase.itemCanvas, 'D', new ItemStack(Items.dye, 1, 15 - color));
        }
        GameRegistry.registerItem(RedPowerBase.itemLumar, "lumar");
        GameRegistry.registerItem(RedPowerBase.itemResource, "resource");
        ...
        GameRegistry.registerItem(RedPowerBase.itemAlloy, "alloy");
        OreDictionary.registerOre("ingotBrass", RedPowerBase.itemIngotBrass);
        GameRegistry.registerItem(RedPowerBase.itemNugget, "nugget");
    ...
    public static void initIndigo() {
        GameRegistry.registerItem(RedPowerBase.itemDyeIndigo = new ItemDyeIndigo(), "dyeIndigo");
        OreDictionary.registerOre("dyeBlue", new ItemStack(RedPowerBase.itemDyeIndigo));
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 11), RedPowerBase.itemDyeIndigo, Blocks.wool);
        GameRegistry.addShapelessRecipe(new ItemStack(Items.dye, 2, 12), RedPowerBase.itemDyeIndigo, new ItemStack(Items.dye, 1, 15));
        GameRegistry.addShapelessRecipe(new ItemStack(Items.dye, 2, 6), RedPowerBase.itemDyeIndigo, new ItemStack(Items.dye, 1, 2));
        GameRegistry.addShapelessRecipe(new ItemStack(Items.dye, 2, 5), RedPowerBase.itemDyeIndigo, new ItemStack(Items.dye, 1, 1));
        GameRegistry.addShapelessRecipe(new ItemStack(Items.dye, 3, 13), RedPowerBase.itemDyeIndigo, new ItemStack(Items.dye, 1, 1), new ItemStack(Items.dye, 1, 9));
        GameRegistry.addShapelessRecipe(new ItemStack(Items.dye, 4, 13), RedPowerBase.itemDyeIndigo, new ItemStack(Items.dye, 1, 1), new ItemStack(Items.dye, 1, 1), new ItemStack(Items.dye, 1, 15));
        CraftLib.addShapelessOreRecipe(new ItemStack(RedPowerBase.itemLumar, 2, 11), Items.redstone, "dyeBlue", "dyeBlue", Items.glowstone_dust);
        CraftLib.addOreRecipe(new ItemStack(RedPowerBase.itemBag, 1, 11), "CCC", "CDC", "CCC", 'C', RedPowerBase.itemCanvas, 'D', "dyeBlue");
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(RedPowerBase.itemPlanBlank), Items.paper, RedPowerBase.itemDyeIndigo);
        GameRegistry.registerItem(RedPowerBase.itemPlanBlank, "planBlank");
        GameRegistry.registerItem(RedPowerBase.itemPlanFull = new ItemPlan(), "planFull");
    }
    
    public static void initAlloys() {
        CraftLib.addAlloyResult(RedPowerBase.itemIngotRed, new ItemStack(Items.redstone, 4), new ItemStack(Items.iron_ingot, 1));
        CraftLib.addAlloyResult(RedPowerBase.itemIngotRed, new ItemStack(Items.redstone, 4), new OreStack("ingotCopper"));
        CraftLib.addAlloyResult(CoreLib.copyStack(RedPowerBase.itemIngotBrass, 4), new OreStack("ingotTin"), new OreStack("ingotCopper", 3));
        CraftLib.addAlloyResult(CoreLib.copyStack(RedPowerBase.itemTinplate, 4), new OreStack("ingotTin"), new ItemStack(Items.iron_ingot, 2));
        CraftLib.addAlloyResult(RedPowerBase.itemIngotBlue, new OreStack("ingotSilver"), new OreStack("dustNikolite", 4));
        ...
        CraftLib.addAlloyResult(new ItemStack(Items.iron_ingot, 1), CoreLib.copyStack(RedPowerBase.itemNuggetIron, 9));
        CraftLib.addAlloyResult(RedPowerBase.itemIngotSilver, CoreLib.copyStack(RedPowerBase.itemNuggetSilver, 9));
        CraftLib.addAlloyResult(RedPowerBase.itemIngotCopper, CoreLib.copyStack(RedPowerBase.itemNuggetCopper, 9));
        CraftLib.addAlloyResult(RedPowerBase.itemIngotTin, CoreLib.copyStack(RedPowerBase.itemNuggetTin, 9));
        CraftLib.addAlloyResult(RedPowerBase.itemIngotTungsten, CoreLib.copyStack(RedPowerBase.itemNuggetTungsten, 9));
        CraftLib.addAlloyResult(RedPowerBase.itemIngotCopper, RedPowerBase.itemFineCopper);
        CraftLib.addAlloyResult(new ItemStack(Items.iron_ingot, 1), RedPowerBase.itemFineIron);
        CraftLib.addAlloyResult(RedPowerBase.itemBouleSilicon, new ItemStack(Items.coal, 8, 0), new ItemStack(Blocks.sand, 8));
        CraftLib.addAlloyResult(RedPowerBase.itemBouleSilicon, new ItemStack(Items.coal, 8, 1), new ItemStack(Blocks.sand, 8));
        CraftLib.addAlloyResult(RedPowerBase.itemWaferBlue, CoreLib.copyStack(RedPowerBase.itemWaferSilicon, 1), new OreStack("dustNikolite", 4));
        CraftLib.addAlloyResult(RedPowerBase.itemWaferRed, CoreLib.copyStack(RedPowerBase.itemWaferSilicon, 1), new ItemStack(Items.redstone, 4));
    }
    
    public static void initMicroblocks() {
        (RedPowerBase.blockMicro = new BlockMicro()).setBlockName("rpwire");
        GameRegistry.registerBlock(RedPowerBase.blockMicro, ItemMicro.class, "microblock");
        RedPowerBase.blockMicro.addTileEntityMapping(0, (Supplier)TileCovered::new);
        CoverLib.blockCoverPlate = RedPowerBase.blockMicro;
    }
    ...
    public static void initAchievements() {
        AchieveLib.registerAchievement("rpMakeAlloy", 0, 0, new ItemStack(RedPowerBase.blockAppliance, 1, 0), AchievementList.buildFurnace);
        AchieveLib.registerAchievement("rpMakeSaw", 4, 0, new ItemStack(RedPowerBase.itemHandsawDiamond), AchievementList.diamonds);
        AchieveLib.registerAchievement("rpIngotRed", 2, 2, RedPowerBase.itemIngotRed, "rpMakeAlloy");
        AchieveLib.registerAchievement("rpIngotBlue", 2, 4, RedPowerBase.itemIngotBlue, "rpMakeAlloy");
        AchieveLib.registerAchievement("rpIngotBrass", 2, 6, RedPowerBase.itemIngotBrass, "rpMakeAlloy");
        AchieveLib.registerAchievement("rpAdvBench", -2, 0, new ItemStack(RedPowerBase.blockAppliance, 1, 3), AchievementList.buildWorkBench);
        AchieveLib.addCraftingAchievement(new ItemStack(RedPowerBase.blockAppliance, 1, 0), "rpMakeAlloy");
        AchieveLib.addCraftingAchievement(new ItemStack(RedPowerBase.blockAppliance, 1, 3), "rpAdvBench");
    ...
    public static void initBlocks() {
        GameRegistry.registerBlock(RedPowerBase.blockMultiblock = new BlockMultiblock(), "multiblock");
        GameRegistry.registerTileEntity(TileMultiblock.class, "RPMulti");
        GameRegistry.registerBlock(RedPowerBase.blockAppliance = new BlockAppliance(), ItemExtended.class, "appliance");
        ...
        GameRegistry.addRecipe(new ItemStack(RedPowerBase.blockAppliance, 1, 0), "BBB", "B B", "BBB", 'B', Blocks.brick_block);
        ...
        CraftLib.addOreRecipe(new ItemStack(RedPowerBase.blockAppliance, 1, 3), "SSS", "WTW", "WCW", 'S', Blocks.stone, 'W', "plankWood", 'T', Blocks.crafting_table, 'C', Blocks.chest);
        (RedPowerBase.itemHandsawIron = new ItemHandsaw(0)).setUnlocalizedName("handsawIron");
        ...
        (RedPowerBase.itemHandsawDiamond = new ItemHandsaw(2)).setUnlocalizedName("handsawDiamond");
        ...
        GameRegistry.addRecipe(new ItemStack(RedPowerBase.itemHandsawIron, 1), "WWW", " II", " II", 'I', Items.iron_ingot, 'W', Items.stick);
        GameRegistry.addRecipe(new ItemStack(RedPowerBase.itemHandsawDiamond, 1), "WWW", " II", " DD", 'I', Items.iron_ingot, 'D', Items.diamond, 'W', Items.stick);
        GameRegistry.addShapelessRecipe(CoreLib.copyStack(RedPowerBase.itemWaferSilicon, 16), RedPowerBase.itemBouleSilicon, new ItemStack(RedPowerBase.itemHandsawDiamond, 1, 32767));
        RedPowerBase.itemScrewdriver = new ItemScrewdriver();
        GameRegistry.addRecipe(new ItemStack(RedPowerBase.itemScrewdriver, 1), "I ", " W", 'I', Items.iron_ingot, 'W', Items.stick);
        GameRegistry.registerItem(RedPowerBase.itemScrewdriver, "screwdriver");
        GameRegistry.addRecipe(new ItemStack(RedPowerBase.itemDrawplateDiamond, 1), " I ", "IDI", " I ", 'I', new ItemStack(RedPowerBase.blockMicro, 1, 5649), 'D', new ItemStack(RedPowerBase.blockMicro, 1, 4115));
        GameRegistry.addShapelessRecipe(RedPowerBase.itemFineIron, Items.iron_ingot, new ItemStack(RedPowerBase.itemDrawplateDiamond, 1, 32767));
        CraftLib.addShapelessOreRecipe(RedPowerBase.itemFineCopper, "ingotCopper", new ItemStack(RedPowerBase.itemDrawplateDiamond, 1, 32767));
        GameRegistry.addRecipe(CoreLib.copyStack(RedPowerBase.itemNuggetIron, 9), "I", 'I', Items.iron_ingot);
        CraftLib.addOreRecipe(CoreLib.copyStack(RedPowerBase.itemNuggetCopper, 9), "I", 'I', "ingotCopper");
        CraftLib.addOreRecipe(CoreLib.copyStack(RedPowerBase.itemNuggetTin, 9), "I", 'I', "ingotTin");
        CraftLib.addOreRecipe(CoreLib.copyStack(RedPowerBase.itemNuggetSilver, 9), "I", 'I', "ingotSilver");
        CraftLib.addOreRecipe(CoreLib.copyStack(RedPowerBase.itemNuggetTungsten, 9), "I", 'I', "ingotTungsten");
        GameRegistry.addRecipe(new ItemStack(Items.iron_ingot, 1, 0), "III", "III", "III", 'I', RedPowerBase.itemNuggetIron);
        GameRegistry.addRecipe(RedPowerBase.itemIngotSilver, "III", "III", "III", 'I', RedPowerBase.itemNuggetSilver);
        GameRegistry.addRecipe(RedPowerBase.itemIngotTin, "III", "III", "III", 'I', RedPowerBase.itemNuggetTin);
        GameRegistry.addRecipe(RedPowerBase.itemIngotCopper, "III", "III", "III", 'I', RedPowerBase.itemNuggetCopper);
        GameRegistry.addRecipe(RedPowerBase.itemIngotTungsten, "III", "III", "III", 'I', RedPowerBase.itemNuggetTungsten);
        GameRegistry.addRecipe(RedPowerBase.itemCanvas, "SSS", "SWS", "SSS", 'S', Items.string, 'W', Items.stick);
        GameRegistry.addRecipe(new ItemStack(Items.diamond, 2), "D", 'D', new ItemStack(RedPowerBase.blockMicro, 1, 4115));
        GameRegistry.addRecipe(new ItemStack(Items.diamond, 1), "D", 'D', new ItemStack(RedPowerBase.blockMicro, 1, 19));
        GameRegistry.addRecipe(new ItemStack(Items.iron_ingot, 2), "I", 'I', new ItemStack(RedPowerBase.blockMicro, 1, 4113));
        GameRegistry.addRecipe(new ItemStack(Items.iron_ingot, 1), "I", 'I', new ItemStack(RedPowerBase.blockMicro, 1, 17));
    }
    
    @Mod.EventHandler
    public void preInit(final FMLPreInitializationEvent event) {
        if (FMLCommonHandler.instance().getSide().isClient()) {
            MinecraftForge.EVENT_BUS.register(RedPowerBase.instance);
        }
    }
    ...
    public void load(final FMLInitializationEvent event) {
        ...
        NetworkRegistry.INSTANCE.registerGuiHandler(RedPowerBase.instance, RedPowerBase.instance);
    }
    ...
    public void registerRenderers() {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(TileAlloyFurnace.class, new RenderAlloyFurnace(RedPowerBase.blockAppliance));
        ClientRegistry.bindTileEntitySpecialRenderer(TileAdvBench.class, new RenderAdvBench(RedPowerBase.blockAppliance));
    }
    ...
    public Object getServerGuiElement(final int ID, final EntityPlayer player, final World world, final int x, final int y, final int z) {
        switch (ID) {
            case 1: {
                return new ContainerAlloyFurnace(player.inventory, (TileAlloyFurnace)CoreLib.getTileEntity(world, x, y, z, (Class)TileAlloyFurnace.class));
            }
            case 2: {
                return new ContainerAdvBench(player.inventory, (TileAdvBench)CoreLib.getTileEntity(world, x, y, z, (Class)TileAdvBench.class));
            }
            case 3: {
                return new ContainerBusId(player.inventory, (IRedbusConnectable)CoreLib.getTileEntity(world, x, y, z, (Class)IRedbusConnectable.class));
            }
            case 4: {
